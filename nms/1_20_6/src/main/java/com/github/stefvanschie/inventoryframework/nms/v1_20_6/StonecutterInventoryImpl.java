...
public class StonecutterInventoryImpl extends StonecutterInventory {
  ...
  public void openInventory(@NotNull Player player, @NotNull TextHolder title,
    ...
    ContainerStonecutterImpl containerEnchantmentTable = new ContainerStonecutterImpl(serverPlayer,
        items, message);

    serverPlayer.containerMenu = containerEnchantmentTable;

    int id = containerEnchantmentTable.containerId;
    ClientboundOpenScreenPacket packet = new ClientboundOpenScreenPacket(id, MenuType.STONECUTTER,
        message);
  ...
  private class ContainerStonecutterImpl extends StonecutterMenu {
    ...
    public CraftInventoryView getBukkitView() {
      if (bukkitEntity == null) {
        CraftInventory inventory = new CraftInventoryStonecutter(this.container,
            getResultInventory()) {
          @NotNull
          @Contract(pure = true)
          @Override
