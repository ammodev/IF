...
public class MerchantInventoryImpl extends MerchantInventory {
  ...
  public void sendMerchantOffers(@NotNull Player player,
    ...
    for (Map.Entry<? extends MerchantRecipe, ? extends Integer> entry : trades) {
      ...
      net.minecraft.world.item.ItemStack nmsItemResult = CraftItemStack.asNMSCopy(
          recipe.getResult());
  ...
  private ItemCost convertItemStackToItemCost(
      @NotNull net.minecraft.world.item.ItemStack itemStack) {
