 ...
 * @since 0.8.0
 */
class FurnaceGui : NamedGui, InventoryBased {
    /**
    ...
    /**
     * Constructs a new furnace gui for the given `plugin`.
     *
     * @param title the title/name of this gui.
    ...
    @Contract(pure = true)
    override fun copy(): FurnaceGui {
        val gui: FurnaceGui = FurnaceGui(getTitleHolder(), super.plugin)
    ...
    override fun createInventory(): Inventory {
        val inventory: Inventory = getTitleHolder().asInventoryTitle(this, InventoryType.FURNACE)
    ...
    companion object {
         ...
         */
        @Contract(pure = true)
        fun load(instance: Any, inputStream: InputStream, plugin: Plugin): FurnaceGui? {
            try {
        ...
        fun load(
            ...
            val furnaceGui: FurnaceGui = FurnaceGui(element.getAttribute("title"), plugin)
            ...
            for (index in 0 until childNodes.getLength()) {
                ...
                when (componentElement.getAttribute("name")) {
                    "ingredient" -> component =
                        furnaceGui.ingredientComponent

                    "fuel" -> component = furnaceGui.fuelComponent
                    "output" -> component = furnaceGui.outputComponent
                    "player-inventory" -> component = furnaceGui.playerInventoryComponent
         ...
         */
        @Contract(pure = true)
        fun load(instance: Any, inputStream: InputStream): FurnaceGui? {
            return load(
